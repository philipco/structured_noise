...
def plot_ellipse(covariances, law, text_position):
    ...
    plt.text(text_position[0][0], text_position[0][1], r'$\mathfrak{C}_a$', horizontalalignment='center',
    ...
    plt.text(text_position[1][0], text_position[1][1], r'$\mathfrak{C}_b$', horizontalalignment='center',
             verticalalignment='center', transform=ax.transAxes, fontsize=FONTSIZE, color="tab:red")

    confidence_ellipse(covariances[2], "COV3", ax, edgecolor="grey", zorder=0, lw=3)

    cov3_label = r'$=\mathfrak{C}_{(a+b)/2}$' if law=="normal" else r'$\mathfrak{C}_{(a+b)/2}$'
    ...
    confidence_ellipse(covariances[3], "AVERAGE", ax, edgecolor="green", zorder=0, lw=5)
    plt.text(text_position[3][0], text_position[3][1], s=r'$\frac{1}{2}(\mathfrak{C}_a + \mathfrak{C}_b)$', horizontalalignment='center',
             verticalalignment='center', transform=ax.transAxes, fontsize=FONTSIZE, color="green")
...
def average_of_ellipse():
    ...
    if law == "student":
        ...
        text_position = [[0.55, 0.9], [0.9, 0.55], [0.88, 0.08], [0.82, 0.79]]
    elif law == "synth":
        ...
        text_position = [[0.58, 0.9], [0.9, 0.58], [0.84, 0.08], [0.84, 0.18]]
